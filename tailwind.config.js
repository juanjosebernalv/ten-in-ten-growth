  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'member-0': "url('/src/assets/images/png/members/member0.png')",
        'member-1': "url('/src/assets/images/png/members/member1.png')",
        'member-2': "url('/src/assets/images/png/members/member2.png')",
        'member-3': "url('/src/assets/images/png/members/member3.png')",
        'member-4': "url('/src/assets/images/png/members/member4.png')",
        'member-5': "url('/src/assets/images/png/members/member5.png')",
        'member-6': "url('/src/assets/images/png/members/member6.png')",
        'member-7': "url('/src/assets/images/png/members/member7.png')",
        'member-8': "url('/src/assets/images/png/members/member8.png')",
        'member-9': "url('/src/assets/images/png/members/member9.png')",
        'member-10': "url('/src/assets/images/png/members/member10.png')",
        'member-11': "url('/src/assets/images/png/members/member11.png')",
      },
      listStyleImage: {
